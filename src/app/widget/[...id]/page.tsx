import { CloseBlockPageButton } from "@/app/custom-blocks/(components)/close-block-page-button";
import NotFound from "@/components/global/NotFound";
import SingleWidget from "@/components/widgets/SingleWidget";
...
const page = async ({ params }) => {
  ...
  try {
    const response = await get_api_template({
      url: TapdayApiPaths?.customWidgets.getById(widgetId),
    });
